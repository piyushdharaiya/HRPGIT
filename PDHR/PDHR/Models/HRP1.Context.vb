...
Partial Public Class HRP1Entities
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=HRP1Entities")
    End Sub
    ...
    Public Overridable Property EmpLeaves() As DbSet(Of EmpLeaf)
    ...
    Public Overridable Property View_2() As DbSet(Of View_2)

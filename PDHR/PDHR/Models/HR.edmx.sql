...
-- --------------------------------------------------
-- Date Created: 09/14/2017 09:57:27
-- Generated from EDMX file: E:\Work\Piyush\PDHR\PDHR\Models\HR.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[SalaryComponentMasts] (
    ...
    [CompType] nvarchar(max)  NOT NULL,
    [TypeRsPer] nvarchar(max)  NOT NULL,
    [amount] float  NOT NULL,
    [basedoncomponent] int  NULL,
    [Compcalcutiontype] varchar(10)  NULL
);
GO
